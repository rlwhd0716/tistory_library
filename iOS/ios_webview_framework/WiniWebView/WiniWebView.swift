...
fileprivate final class WiniProcessPool: WKProcessPool {
    static let pool = WiniProcessPool()
}

open class WiniWebView: WKWebView {
    @objc public weak var wkNavigationDelegate: WKNavigationDelegate?
    @objc public var onUpdateCookieStorage: ((WiniWebView) -> Void)?
    ...
    public init(frame: CGRect, configurationBlock: ((WKWebViewConfiguration) -> Void)? = nil) {
        ...
        configuration.processPool = WiniProcessPool.pool
        configurationBlock?(configuration)
        configuration.userContentController = WKUserContentController()
        configuration.userContentController.add(WiniMessageHandler(), name: "Wini")
...
extension WiniWebView: WKNavigationDelegate {
